...
const faqs = [
  {
    ...
    answer: 'Для достижения ощутимых результатов рекомендуется выполнять комплекс упражнений от 2 раз в неделю. При регулярных занятиях первые улучшения вы почувствуете уже через 2-3 недели.'
  },
  {
