...
const exercises = [
  {
    ...
    duration: '5 минут',
    reps: '3 раза по 10 повторений на каждую сторону. Задержка 3 секунды',
  ...
  },
  {
    ...
    reps: '3 раза по 10 повторений',
    videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
    description: 'Техника выполнения: Ложитесь на спину, ноги сгибаем в коленных суставах, стопы ставим на поверхность, руки положить на выступающие тазовые кости и опустите подбородок, наклоняйте таз вперед и назад, как будто наклоняете миску с водой. Нейтральное положение позвоночника находится посередине между этими положениями, где дискомфорт в позвоночнике минимален',
  ...
  },
  {
    ...
    duration: '5 минут',
    reps: '3 раза по 10 повторений. Задержка 3 секунды',
    videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
    description: 'Техника выполнения: Встаньте на четвереньки Прогибаем поясницу, затем скручиваем грудной отдел. На прогибе делаем глубокий вдох, на скручивании плавный выдох',
  ...
  },
  {
    ...
    videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
    description: 'Техника выполнения: Берем мягкий валик без протектора или скручиваем полотенце, кладем валик под лопатки. Ноги сгибаем в коленных суставах, руки за голову, локти в стороны, делаем глубокий вдох, распрямляем грудной отдел и немного прогибаемся назад, с плавным выдохом скручиваем грудной отдел с мягким движением вперед',
    equipment: ['Коврик для йоги']
  }
];
